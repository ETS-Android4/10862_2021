...
public class CBlueCarouselCommandR extends SequentialCommandGroup {
    public CBlueCarouselCommandR(Drivetrain drivetrain, Intake intake, Lift lift, ArmServos armServos, Carousel carousel, SensorColor sensorColor, CapServos capServos) {
//High
        addCommands(
