...
public class CRedWarehouseCommandL extends SequentialCommandGroup {
    public CRedWarehouseCommandL(Drivetrain drivetrain, Intake intake, Lift lift, ArmServos armServos, SensorColor sensorColor, CapServos capServos) {
        ...
        addCommands(
                ...
                new SplineCommand(drivetrain, new Vector2d(22,25.2), Math.toRadians(0)),
                ...
                new WaitCommand(100),
                new SplineCommand(drivetrain, new Vector2d(18.5,22), Math.toRadians(0), true),
                ...
                new LiftHighCommand(lift),
                new WaitCommand(100),
                new SplineCommand(drivetrain, new Vector2d(18.5,22), Math.toRadians(10), true),
                new DropFreightCommand(armServos),
